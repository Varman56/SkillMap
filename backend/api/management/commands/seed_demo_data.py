...
PROJECTS_DATA = [
    {
        ...
        "start_days_ago": 200,
        "end_days_ago": None,
        "departments": ["Разработка", "Аналитика", "Дизайн", "QA"],
    },
    {
        "name": "CRM Обновление",
        ...
        "start_days_ago": 90,
        "end_days_ago": None,
        "departments": ["Разработка", "QA", "DevOps"],
    },
    {
        "name": "Mobile App v2",
        ...
        "start_days_ago": 300,
        "end_days_ago": 30,
        "departments": ["Разработка", "Дизайн", "QA"],
    },
    {
    ...
    },
    {
        ...
        "start_days_ago": 60,
        "end_days_ago": None,
        "departments": ["Аналитика", "Разработка"],
    },
    {
    ...
    },
    {
        ...
        "start_days_ago": 70,
        "end_days_ago": None,
        "departments": ["DevOps", "Разработка"],
    },
    {
        "name": "Система онбординга сотрудников",
        "description": "Автоматизация процесса адаптации новых сотрудников",
        "status": "On Hold",
        "start_days_ago": 120,
        "end_days_ago": None,
        "departments": ["HR", "Разработка", "Продукт"],
    },
    {
        "name": "API для партнёров",
        "description": "Публичное API для внешних интеграций с партнёрами",
        "status": "Active",
        "start_days_ago": 40,
        "end_days_ago": None,
        "departments": ["Разработка", "Аналитика"],
    },
    {
        ...
        "start_days_ago": 50,
        "end_days_ago": 10,
        "departments": ["QA", "DevOps", "Разработка"],
    },
]
